...
from utils import *
from trainer_zo_fine_tuner import OurTrainer_zo_fine_tuner
import random

@dataclass
class OurArguments(TrainingArguments):
    # dataset and sampling strategy
    train_mode: str = 'zo_fine_tuner'
    load_mlp_path: str="N"
    ...
    tag: str = "" # saving tag
    cache_dir: str = "~/.cache/huggingface/transformers"
...
class Framework:
    ...
    def train(self, train_samples, eval_samples):
        ...
        if self.args.only_train_option and not self.args.non_diff:# and not self.args.train_mode == "test_MLP1_SGD_simplify_share_quant":
        ...
        if self.args.train_mode == "zo_fine_tuner":
            trainer = OurTrainer_zo_fine_tuner(
                model=self.model, 
                args=self.args,
...
def main():
    ...
    ### here you can add wandb init operation
